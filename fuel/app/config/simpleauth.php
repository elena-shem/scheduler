...
return array(
	...
	'roles' => array(
        'admin' => array(
            'doctorals' => array('create','read','update','delete'),
			'reports' => array('read'),
            'professors' => array('create','read','update','delete'),
            'users' => array('create','read','update','delete'),
            'courses' => array('create','read','update','delete'),
            'welcome' => array('create','read','update','delete'),
            'emails' => array('create','read','update','delete','send','rearm'),
            'examperiods' => array('create','read','update','delete'),
            'availability' => array('read'),
            'availabilitycalendar' => array('read'),
            'global_settings' => array('read','update'),
            'schedule_creator' => array('create','read','statistics'),
            'assigner' => array('create','read','statistics'),
			'file' => array('upload', 'export', 'import'),
			'examsupervisions' => array('create','read','update','delete'),
        ),
        'moderator' => array(
            'professors' => array('create','read','update','delete'),
            'courses' => array('create','read','update','delete'),
	 ...
	 */
	'login_hash_salt' => '&(Y&(*YSADH&*^76234ydf^&^sdasd',
