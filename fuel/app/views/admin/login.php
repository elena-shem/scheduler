...
<div class="row">
	<div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
		...
		<?php echo Form::open(array()); echo Form::csrf();?>
			...
			<div class="actions">
				<?php echo Form::submit(array('value'=>'Login', 'name'=>'submit', 'class' => 'btn btn-sm btn-primary btn-block')); ?>
                <?php echo Html::anchor('welcome', 'Home', array('class' => 'btn btn-sm btn-warning btn-block')); ?>
			</div>
