...
?>
    ...
    <fieldset>
        ...
        <div class="form-group">
            <?php echo Form::label('Exam Period', 'examperiod', array('class'=>'control-label')); ?>


            <?php echo Form::select('examperiod',$already_selected_exam_period, $exam_periods, array( 'name'=> 'examperiod', 'class' => 'col-md-4 form-control', 'placeholder'=>'Exam Period', 'style' => "resize:both;")); ?>
